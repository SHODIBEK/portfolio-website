      ...
      <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6" @submit.prevent="login">
                  <div>
                      <Input v-model="form.email" placeholder="name@company.com" label="Your email">
                  ...
                  <div>
                    <Input v-model="form.password" :type="!active ? 'password' : 'text'" placeholder="••••••••" label="Password">
                      <template #suffix>
                        <button v-show="form.password" class="flex w-6 h-6 fill-gray-300 hover:fill-primary-600 dark:fill-gray-600 transition" :class="active ? '!fill-primary-600' : ''" title="Show/Hide Password" @click.prevent="active = !active" type="button">
                          <svg v-if="!active" class="w-full h-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 96 960 960">
                          ...
                          <svg v-else class="w-full h-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 96 960 960">
                  ...
                  <Button size="lg" :disabled="loading" :loading="loading" class="w-full justify-center text-center">
